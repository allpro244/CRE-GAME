...
void main() {
  ...
  else if (s == 94) roof = vec3(0.300, 0.310, 0.320); // church: slate
  else if (s == 95) roof = vec3(0.345, 0.335, 0.320); // meeting house: shingle
  else if (s == 96) roof = vec3(0.380, 0.420, 0.400); // synagogue: copper
  else if (s == 97) roof = vec3(0.430, 0.400, 0.375); // hospital pavilion
  else if (s == 98) roof = vec3(0.470, 0.470, 0.455); // cellblock
  else if (s == 99) roof = vec3(0.420, 0.390, 0.370); // armory
  else if (s == 100) roof = vec3(0.315, 0.325, 0.330); // collegiate: slate
  else if (s == 101) roof = vec3(0.545, 0.575, 0.570); // bathhouse: glazed vault
  else if (s == 102) roof = vec3(0.580, 0.590, 0.600); // museum: the skylights
  else if (s == 103) roof = vec3(0.470, 0.400, 0.345); // convent: pantile
  else if (s == 104) roof = vec3(0.400, 0.430, 0.425); // train shed: glazed barrel
  else if (s == 105) roof = vec3(0.435, 0.400, 0.375); // car barn
  else if (s == 106) roof = vec3(0.585, 0.595, 0.595); // hangar: profiled sheet
  else if (s == 107) roof = vec3(0.640, 0.635, 0.615); // bus station: the slab
  else if (s == 108) roof = vec3(0.390, 0.395, 0.400); // control tower: the cab roof
  else if (s == 109) roof = vec3(0.455, 0.440, 0.420); // exchange
  else if (s == 110) roof = vec3(0.470, 0.455, 0.435); // substation
  else if (s == 111) roof = vec3(0.235, 0.235, 0.245); // lighthouse: the gallery
  else if (s == 112) roof = vec3(0.330, 0.430, 0.290); // sky garden: the top terrace
  else if (s == 113) roof = vec3(0.600, 0.620, 0.640); // pleated
  else if (s == 114) roof = vec3(0.560, 0.590, 0.610); // shingled
  else if (s == 115) roof = vec3(0.545, 0.570, 0.590); // double skin
  else if (s == 116) roof = vec3(0.610, 0.612, 0.618); // megabrace
  else if (s == 117) roof = vec3(0.575, 0.595, 0.615); // chevron
  else if (s == 118) roof = vec3(0.600, 0.595, 0.580); // modular
  else if (s == 119) roof = vec3(0.190, 0.205, 0.235); // PV clad: more panels
  else if (s == 120) roof = vec3(0.585, 0.570, 0.545); // podium wrap
  else if (s == 121) roof = vec3(0.545, 0.555, 0.565); // lab: plant everywhere
  else if (s == 122) roof = vec3(0.505, 0.480, 0.450); // creative office
