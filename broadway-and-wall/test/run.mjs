...
const MODULES = ["sim", "leasing", "actions", "credit", "value", "dev", "debt", "demand", "invariants", "rivals", "sponsor"];
...
const run = spawnSync("node", [join(HERE, "invariants.mjs")], { stdio: "inherit", env: process.env });
